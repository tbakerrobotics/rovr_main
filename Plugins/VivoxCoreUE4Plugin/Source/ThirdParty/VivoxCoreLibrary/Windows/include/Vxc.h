...
typedef enum {
    ...
    /**
     * returned by method if app does not have microphone access permission.
     */
 ...
 * @param expiration standard expiration time claim, if set to (vx_time_t)-1 uses default value 300 seconds
 ...
 *
 * @param bits_per_second - [in] The requested bit rate, 6000-128000 bit/s
 * @return 0 if successful, non-zero if failed.
 */
...
typedef enum {
    ...
    tts_error_max_characters_exceeded = -1004, /**< Message exceeded maximum number of characters in input text. Maximum number of characters is 200. */
