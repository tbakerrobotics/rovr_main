...
public:
    ...
    */
     ...
     *
     * \param channelId the id of the channel
     * \remarks Refer to IChannelSession::Disconnect() for timing restrictions relating to joining/rejoining
     *  channels during a disconnect. There are no such timing restrictions when using this method to remove
    ...
    /**
     * \brief The delegate to be called when BeginSetCrossMutedCommunications completes
     */
    ...
    /**
     * \brief "Cross mute" an AccountId, bidirectionally muting audio/text between that account and this login session
     *
     * \param accountId the AccountId to bi-directionally mute or unmute
     * \param muted the status to set, with true as muted and false unmuted
     *
     * \return 0 on success
     */
    ...
    /**
     * \brief "Cross mute" a set of AccountIds, bidirectionally muting audio/text between those accounts and this login session
     *
    ...
    /**
     * \brief The delegate to be called when BeginClearCrossMutedCommunications completes
     */
    ...
    /**
     * \brief Clear the bi-directionally muted communications list, unmuting all AccountIds and allowing audio/text through any way not otherwise prevented
     *
     * \return 0 on success
     */
    ...
    */
    ...
    /**
     * \brief The Text-To-Speech subsystem instance associated with this Login Session
     */
