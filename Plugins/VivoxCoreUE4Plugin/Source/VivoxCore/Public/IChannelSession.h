...
public:
    ...
    */
     ...
     * \param deleteOnDisconnect - Can be set to true to cause the channel to be removed from ILoginSession::ChannelSessions() immediately after sending out the EventChannelStateChanged event to disconnected.
